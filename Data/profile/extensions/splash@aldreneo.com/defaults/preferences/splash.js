...
pref("splash.imageURL", "chrome://branding/content/inicio2.png");
pref("splash.windowWidth", 640);
pref("splash.windowHeight", 324);

pref("splash.textHide", false);
pref("splash.progressMeterHide", false);
pref("splash.textOverride", "Cargando galería...");
